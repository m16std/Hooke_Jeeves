    ...
    public partial class MainWindow : Window
    {
        ...
        private void About(object sender, RoutedEventArgs e)
        {
            MessageBox.Show("Метод Хука — Дживса (англ. Hooke — Jeeves), также известный как метод конфигураций — как и алгоритм Нелдера — Мида, служит для поиска безусловного локального " +
                ...
                "x3 = x1 + λ ( x2 − x1 ), где xi — точка с номером i, " +
                "λ — коэффициент усиления, обычно выбирающийся равным 2. Затем в новой точке 3 проводится исследующий поиск, как на 1 фазе алгоритма, за исключением того, что шаг на этой фазе не уменьшается." +
